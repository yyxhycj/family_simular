...
Data.Relics = {
    ...
    { id = "ruler", name = "一把老木尺", cost = 6, saleValue = 14, basic = true, unlock = "plan", event = "ruler", desc = "尺背有陌生的匠号。查明匠号后寻回一张营造图。", story = { source = "开局带入", executor = "调查者", title = "木尺上的旧刻痕", body = "修补桌脚时，木尺背面那枚浅浅的匠号又露了出来。镇上老匠说，旧祠堂里或许还留着那个人的图。", fast = { label = "带着木尺，去旧祠堂问问" }, slow = { label = "托旧识慢慢查访" }, restore = "修复图样", defer = "暂存线索" } },
